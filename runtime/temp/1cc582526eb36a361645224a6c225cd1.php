<?php /*a:2:{s:55:"D:\mf\pcnfctest\application\admin\view\order\index.html";i:1543196952;s:57:"D:\mf\pcnfctest\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            <div class="ftitle">
                <h3>订单列表</h3>
                <h5>(共<span id="order_count"></span>条记录)</h5>
            </div>
            <div title="刷新数据" class="pReload"><i class="fa fa-refresh"></i></div>
            <form class="navbar-form form-inline" method="post" action="<?php echo url('Admin/order/export_order'); ?>"
                ...
                <div class="sDiv">
                    <div class="sDiv2">
                        <select name="suppliers_id" class="select sDiv3">
                    ...
                    <div class="sDiv2">
                        <input type="text" size="30" id="start_time" name="start_time" value="<?php echo htmlentities($start_time); ?>"
                               class="qsbox" placeholder="下单开始时间">
                    </div>
                    <div class="sDiv2">
                        <input type="text" size="30" id="end_time" name="end_time" value="<?php echo htmlentities($end_time); ?>" class="qsbox"
                               placeholder="下单结束时间">
                    </div>
                    <div class="sDiv2">
                    ...
                    <div class="sDiv2">
                        <select name="order_status" class="select sDiv3">
                            ...
                            <option value="<?php echo htmlentities($k-1); ?>"><?php echo htmlentities($v); ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <div class="sDiv2">
...
<script type="text/javascript">
    ...
    function ajax_get_table(tab, page) {
        ...
        $.ajax({
            type: "POST",
            url: "/index.php/Admin/order/ajaxindex?page=" + page,//+tab,
            data: $('#' + tab).serialize(),//
            success: function (data) {
                $("#flexigrid").html('');
