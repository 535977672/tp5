<?php /*a:1:{s:55:"D:\mf\pcnfc\application\admin\view\order\add_order.html";i:1542359974;}*/ ?>
    ...
    <form class="form-horizontal" action="<?php echo U('Admin/Order/addOrder'); ?>" id="order-add" method="post">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="invoice_title" value="<?php echo htmlentities($order['invoice_title']); ?>" class="input-txt"  placeholder="发票抬头" maxlength="20"/>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                ...
                <dd class="opt">
                    <input type="text" name="taxpayer" id="taxpayer" value="<?php echo htmlentities($order['taxpayer']); ?>" class="input-txt"  placeholder="纳税人识别号"/>
                </dd>
            </dl>
            ...
            <input type="hidden" name="order_id" value="<?php echo htmlentities($order['order_id']); ?>">
