<?php /*a:2:{s:50:"D:\mf\pcnfc\application\admin\view\admin\role.html";i:1542157672;s:53:"D:\mf\pcnfc\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
	...
	<div class="flexigrid">
		...
		<div class="bDiv" style="height: auto;">
			<div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
				<table>
					<tbody>
					<?php foreach($list as $k=>$vo): if($vo['role_id'] > 1): ?>
							<tr>
								<td class="sign">
									<div style="width: 24px;"><i class="ico-check"></i></div>
								</td>
								<td align="left" class="">
									<div style="text-align: left; width: 100px;"><?php echo htmlentities($vo['role_id']); ?></div>
								</td>
								<td align="left" class="">
									<div style="text-align: left; width: 100px;"><?php echo htmlentities($vo['role_name']); ?></div>
								</td>
								<td align="left" class="">
									<div style="text-align: left; width: 100px;"><?php echo htmlentities($vo['role_desc']); ?></div>
								</td>
								<td align="center" class="handle">
									<div style="text-align: center; width: 170px; max-width:170px;">
										...
										<a class="btn red"  href="javascript:void(0)" data-url="<?php echo url('Admin/roleDel'); ?>" data-id="<?php echo htmlentities($vo['role_id']); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
									</div>
								</td>
