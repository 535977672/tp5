<?php /*a:2:{s:57:"D:\mf\pcnfc\application\admin\view\system\right_list.html";i:1542274665;s:53:"D:\mf\pcnfc\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
					...
					<div class="sDiv2">
						<select  name="type" class="select">
							<?php if(is_array($modules) || $modules instanceof \think\Collection || $modules instanceof \think\Paginator): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$module): $mod = ($i % 2 );++$i;?>
								<option value="<?php echo htmlentities($key); ?>" <?php if(app('request')->get('type') == $key): ?>selected<?php endif; ?>><?php echo htmlentities($module['title']); ?>(<?php echo htmlentities($module['name']); ?>)</option>
		...
		<div class="tDiv">
			<div class="tDiv2">
				<div class="fbutton">
					<a href="<?php echo url('System/edit_right',array('type'=>0)); ?>">
		...
		<div class="bDiv" style="height: auto;">
			<div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
				<table>
					<tbody>
					<?php foreach($right_list as $k=>$vo): ?>
						<tr>
							<td class="sign">
								<div style="width: 24px;"><i class="ico-check"></i></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo htmlentities($vo['name']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo htmlentities($modules[$vo['type']]['title']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo htmlentities($group[$vo['group']]); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 500px;"><?php echo htmlentities($vo['right']); ?></div>
							</td>
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									...
									<a class="btn red"  href="javascript:void(0)" data-url="<?php echo url('System/right_del'); ?>" data-id="<?php echo htmlentities($vo['id']); ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
