<?php /*a:2:{s:55:"D:\mf\pcnfc\application\admin\view\user\level_list.html";i:1543196952;s:53:"D:\mf\pcnfc\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		...
		<div class="tDiv">
			<div class="tDiv2">
				<div class="fbutton"> <a href="<?php echo url('User/level'); ?>">
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 50px;"><?php echo htmlentities($vo['level_id']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 50px;"><?php echo htmlentities($vo['level_name']); ?></div>
							</td>
							...
							<td align="center" class="">
								<div style="text-align: center; width: 50px;"><?php echo htmlentities($vo['discount']); ?>%</div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 100px;"><?php echo htmlentities($vo['describe']); ?></div>
							</td>
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo url('User/level',array('act'=>'edit','level_id'=>$vo['level_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
									<a class="btn red"  href="javascript:void(0)" data-url="<?php echo url('User/levelHandle'); ?>" data-id="<?php echo htmlentities($vo['level_id']); ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
