<?php /*a:1:{s:57:"D:\mf\pcnfc\application\admin\view\order\return_list.html";i:1542359974;}*/ ?>
  ...
  <div class="flexigrid">
    <div class="mDiv">
	  ...
	  <form class="navbar-form form-inline"  method="post" name="search-form2" id="search-form2">  
            ...
            <input type="hidden" name="user_id" value="<?php echo htmlentities($_GET[user_id]); ?>">
            <!--用于查看结算统计 包含了哪些订单-->
