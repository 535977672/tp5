<?php /*a:2:{s:56:"D:\mf\pcnfctest\application\admin\view\info\comment.html";i:1543217255;s:57:"D:\mf\pcnfctest\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" action="<?php echo url('Info/comment'); ?>" method="get">
				<div class="sDiv">
					<div class="sDiv2">
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="left" abbr="info_type" axis="col4" class="">
							<div style="text-align: left; width: 50px;" class="">父用户名</div>
						</th>
						<th align="left" abbr="info_type" axis="col4" class="">
							<div style="text-align: left; width: 50px;" class="">资讯ID</div>
						</th>
						<th align="left" abbr="info_content" axis="col6" class="">
							<div style="text-align: left; width: 300px;" class="">内容</div>
						</th>
				...
				<table>
					...
					<?php foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 30px;"><?php echo htmlentities($vo['comment_id']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 50px;"><?php echo htmlentities($vo['nickname']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 50px;"><?php echo htmlentities($vo['pnickname']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 50px;"><a href="<?php echo url('Info/detail', ['id' => $vo['goods_id']]); ?>"><?php echo htmlentities($vo['goods_id']); ?></a></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 300px;"><?php echo htmlentities($vo['content']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 120px;"><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($vo['add_time'])? strtotime($vo['add_time']) : $vo['add_time'])); ?></div>
							</td>
							<td align="center" class="handle">
								<div style="text-align: center; width: 50px; max-width:50px;">
									<a class="btn red"  href="javascript:void(0)" data-url="<?php echo url('Info/delComment'); ?>" data-id="<?php echo htmlentities($vo['comment_id']); ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
