<?php /*a:2:{s:65:"D:\mf\pcnfctest\application\admin\view\goods\_goodsAttribute.html";i:1543196952;s:57:"D:\mf\pcnfctest\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <div class="fixed-bar">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
            <input type="text" value="<?php echo htmlentities($goodsAttribute['attr_name']); ?>" name="attr_name"  class="input-txt" />
        ...
        <dd class="opt">
            ...
            <select name="type_id" id="type_id" class="small form-control">
                ...
                <?php if(is_array($goodsTypeList) || $goodsTypeList instanceof \think\Collection || $goodsTypeList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                 <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $goodsAttribute['type_id']): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
            <textarea rows="10" cols="30" name="attr_values" class="input-txt" style="height:100px;"><?php echo htmlentities($goodsAttribute['attr_values']); ?></textarea>
            <span id="err_attr_values" class="err" style="color:#F00; display:none;"></span>                  
            <p class="notic">不同值用换行区分</p>
        </dd>
      </dl>	                 
      <div class="bot"><a href="JavaScript:void(0);" onclick="ajax_submit_form('addEditGoodsAttributeForm','<?php echo url('Goods/addEditGoodsAttribute?is_ajax=1'); ?>');"  class="ncap-btn-big ncap-btn-green" id="submitBtn">确认提交</a></div>
    </div>
	   <input type="hidden" name="attr_id" value="<?php echo htmlentities($goodsAttribute['attr_id']); ?>">
  </form>
</div>
