<?php /*a:1:{s:58:"D:\mf\pcnfc\application\admin\view\order\virtual_list.html";i:1542359974;}*/ ?>
...
<div class="page">
  ...
  <div class="flexigrid">
    <div class="mDiv">
      <div class="ftitle">
        <h3>订单列表</h3>
        <h5>(共<?php echo htmlentities($total_count); ?>条记录)</h5>
      </div>
	  ...
	  <form class="navbar-form form-inline"  method="post" action="<?php echo U('Order/export_order'); ?>"  name="search-form2" id="search-form2">
          ...
          <div class="sDiv">
            <div class="sDiv2">
                <input type="text" size="30" id="start_time" name="start_time" value="<?php echo htmlentities($start_time); ?>" class="qsbox"  placeholder="下单开始时间">
            </div>
            <div class="sDiv2">
                <input type="text" size="30" id="end_time" name="end_time" value="<?php echo htmlentities($end_time); ?>" class="qsbox"  placeholder="下单结束时间">
            </div>
            <div class="sDiv2">
