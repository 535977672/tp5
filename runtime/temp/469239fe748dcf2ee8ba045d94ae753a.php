<?php /*a:2:{s:55:"D:\mf\pcnfctest\application\admin\view\admin\index.html";i:1542157672;s:57:"D:\mf\pcnfctest\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table>
					...
					<?php foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo htmlentities($vo['admin_id']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo htmlentities($vo['user_name']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo htmlentities($vo['admin_role']['role_name']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 200px;"><?php echo htmlentities($vo['email']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 200px;"><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($vo['add_time'])? strtotime($vo['add_time']) : $vo['add_time'])); ?></div>
							</td>
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									...
									<?php if($vo['admin_id'] > 1): ?>
										<a class="btn red"  href="javascript:void(0)" data-url="<?php echo url('Admin/adminHandle'); ?>" data-id="<?php echo htmlentities($vo['admin_id']); ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
									<?php endif; ?>
								</div>
							</td>
