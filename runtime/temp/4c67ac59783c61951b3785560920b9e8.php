<?php /*a:2:{s:56:"D:\mf\pcnfc\application\admin\view\goods\_goodsType.html";i:1543196952;s:53:"D:\mf\pcnfc\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--商品类型-->     
      <dl class="row">
        ...
        <dd class="opt">
            <input type="text" value="<?php echo htmlentities($goodsType['name']); ?>" name="name" class="input-txt" style="width:300px;"/>
...
<!--商品类型 end-->       
	 ...
	 <input type="hidden" name="id" value="<?php echo htmlentities($goodsType['id']); ?>">
  </form>
