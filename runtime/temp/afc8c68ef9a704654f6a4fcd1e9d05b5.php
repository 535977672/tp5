<?php /*a:2:{s:52:"D:\mf\pcnfc\application\admin\view\report\index.html";i:1543196952;s:53:"D:\mf\pcnfc\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			<div class="ftitle">
				<h3>销售概况</h3>
				<h5>今日销售总额：￥<?php if(empty($today['today_amount']) || (($today['today_amount'] instanceof \think\Collection || $today['today_amount'] instanceof \think\Paginator ) && $today['today_amount']->isEmpty())): ?>0<?php else: ?><?php echo htmlentities($today['today_amount']); endif; ?>|人均客单价：￥<?php echo htmlentities($today['sign']); ?>|今日订单数：<?php echo htmlentities($today['today_order']); ?>|今日取消订单：<?php echo htmlentities($today['cancel_order']); ?></h5>
			</div>
			<div title="刷新数据" class="pReload"><i class="fa fa-refresh"></i></div>
			<form class="navbar-form form-inline" id="search-form" method="get" action="<?php echo url('Report/index'); ?>" >
				<div class="sDiv">
					<div class="sDiv2" style="margin-right: 10px;">
						<input type="text" size="30" name="start_time" id="start_time" value="<?php echo htmlentities($start_time); ?>" placeholder="起始时间" class="qsbox">
						<input type="button" class="btn" value="起始时间">
					</div>
					<div class="sDiv2" style="margin-right: 10px;">
						<input type="text" size="30" name="end_time" id="end_time" value="<?php echo htmlentities($end_time); ?>" placeholder="截止时间" class="qsbox">
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
						<tr>
							...
							<td align="center" class="">
								<div style="text-align: center; width: 120px;"><?php echo htmlentities($vo['day']); ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 100px;"><?php echo htmlentities($vo['order_num']); ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 100px;"><?php echo htmlentities($vo['amount']); ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 100px;"><?php echo htmlentities($vo['sign']); ?></div>
							</td>
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo url('Report/saleOrder',array('start_time'=>$vo['day'],'end_time'=>$vo['end'])); ?>" class="btn blue"><i class="fa fa-search"></i>查看订单列表</a>
								</div>
							</td>
...
<script src="/static/js/echart/echarts.min.js" type="text/javascript"></script>
<script src="/static/js/echart/macarons.js"></script>
<script src="/static/js/echart/china.js"></script>
<script src="/static/dist/js/app.js" type="text/javascript"></script>
<script type="text/javascript">
	var res = <?php echo htmlentities($result); ?>;
