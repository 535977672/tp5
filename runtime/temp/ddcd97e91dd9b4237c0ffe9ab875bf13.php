<?php /*a:2:{s:50:"D:\mf\pcnfc\application\admin\view\user\index.html";i:1542359974;s:53:"D:\mf\pcnfc\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <div class="sDiv">
                    <div class="sDiv2">
                        ...
                        <input type="text" id="search_key" size="30" class="qsbox" placeholder="查询"
                               value="<?php echo htmlentities(app('request')->param('search_key')); ?>">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="email" axis="col6" class="">
                            <div style="text-align: center; width: 70px;" class="">邮件地址</div>
                        </th>
...
<script>
    ...
    function ajax_get_table(tab, page) {
        ...
        $.ajax({
            type: "POST",
            url: "/index.php/Admin/user/ajaxindex?page=" + page,//+tab,
    ...
    function send_message() {
        var obj = $('.trSelected');
        var url = "<?php echo url('Admin/User/sendMessage'); ?>";
        if (obj.length > 0) {
            var check_val = [];
            obj.each(function () {
                check_val.push($(this).attr('data-id'));
    ...
    function exportUser() {
        ...
        $('#search-form2').attr('action', "<?php echo url('User/export_user'); ?>")
        var selected_ids = '';
