<?php /*a:2:{s:52:"D:\mf\pcnfc\application\admin\view\tools\region.html";i:1541756597;s:53:"D:\mf\pcnfc\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	<div id="list">
		...
		<div class="flexigrid">
			<div class="mDiv">
				<div class="ftitle">
					<h3>地区列表</h3>
					<h5>(共<?php echo htmlentities($total); ?>条记录)</h5>
				</div>
				<div title="刷新数据" class="pReload"><i class="fa fa-refresh"></i></div>
				<notempty name="parent_path"><div title="上级区域" class="pReload"><?php if($parent_path): ?>上级区域:<?php echo htmlentities($parent_path); endif; ?></div></notempty>
			</div>
			<div class="hDiv">
				<div class="hDivBox">
							...
							<tr id="row130" data-id="130" class="">
								...
								<td class="handle" align="center">
									<div style="text-align: center; width: 150px;">
										<a class="btn red" data-url="<?php echo url('Tools/regionHandle',array('id'=>$vo['id'])); ?>"  onclick="delRegion(this);"><i class="fa fa-trash-o"></i>删除</a>
										<span class="btn"><em><i class="fa fa-cog"></i>设置 <i class="arrow"></i></em><ul>
										<li><a href="<?php echo url('Admin/Tools/region',array('op'=>'add','parent_id'=>$vo['id'])); ?>">新增下级</a></li>
										<li><a href="<?php echo url('Admin/Tools/region',array('parent_id'=>$vo['id'])); ?>">查看下级</a></li>
									</ul></span></div>
								</td>
								<td class="" align="left">
								...
								<td class="" align="left">
									<div style="text-align: left; width: 100px;"><?php echo htmlentities($vo['level']); ?></div>
								</td>
								<td class="" align="center">
									<div style="text-align: center; width: 140px;"><?php echo htmlentities($vo['parent_id']); ?></div>
								</td>
	...
	<div id="add_region" style="display: none">
		<div class="page">
			...
			<form id="add_region_form" method="post" action="<?php echo url('Tools/regionHandle'); ?>">
				<input type="hidden" name="level" value="<?php echo htmlentities($parent['level']); ?>">
				...
				<div class="ncap-form-default">
					...
					<notempty name="parent_path">
						<dl class="row">
							...
							<dd class="opt"><label for="name"><?php echo htmlentities($parent_path); ?></label></dd>
						</dl>
					</notempty>
                    <?php endif; ?>
					<dl class="row">
...
<script>
    ...
    <?php if(app('request')->param('op') == 'add'): ?>
			add_region(1);
    <?php endif; ?>
	...
	{
		window.location.href = "<?php echo url('Tools/region',array('parent_id'=>$parent['parent_id'])); ?>";
	}
