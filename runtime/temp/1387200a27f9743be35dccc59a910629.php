<?php /*a:2:{s:51:"D:\mf\pcnfc\application\admin\view\user\detail.html";i:1543196952;s:53:"D:\mf\pcnfc\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="user_form" method="post">
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input class="input-txt valid" name="nickname" value="<?php echo htmlentities($user['nickname']); ?>" readonly="" type="text">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <strong class="red"><?php echo htmlentities($user['user_money']); ?></strong>&nbsp;余额 &nbsp;&nbsp;
                    <strong class="red"><?php echo htmlentities($user['pay_points']); ?></strong>&nbsp;积分
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                ...
                <dd class="opt">
                    <select id="level" name="level">
                        <?php if(is_array($levelList) || $levelList instanceof \think\Collection || $levelList instanceof \think\Paginator): $i = 0; $__LIST__ = $levelList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo htmlentities($key); ?>" {if condition="$key eq $user.level" }selected{
                        /if}><?php echo htmlentities($v); ?></option>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="email" name="email" value="<?php echo htmlentities($user['email']); ?>" class="input-txt" type="text">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="mobile" name="mobile" value="<?php echo htmlentities($user['mobile']); ?>" class="input-txt" type="text">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="qq" name="qq" value="<?php echo htmlentities($user['qq']); ?>" class="input-txt" type="text">
                    <span class="err"></span></dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                ...
                <dd class="opt"><?php echo htmlentities(date('Y-m-d H:i',!is_numeric($user['reg_time'])? strtotime($user['reg_time']) : $user['reg_time'])); ?></dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label>冻结会员</label>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div style="height:160px;">
                        ...
                        <span class="span_1">
                            <ul>
                                <li><strong class="red"><?php echo htmlentities($user['user_money']); ?></strong>&nbsp;元 </li>
                                <li>
                                    <?php if($user['first_leader'] > 0): ?>
                                        <a href="<?php echo url(detail,array('id'=>$user[first_leader])); ?>"><?php echo htmlentities($user['first_leader']); ?></a>
                                        <?php else: ?>
                                        <?php echo htmlentities($user['first_leader']); endif; ?>
                                </li>
                                <li>
                                    <?php if($user['second_leader'] > 0): ?>
                                        <a href="<?php echo url(detail,array('id'=>$user[second_leader])); ?>"><?php echo htmlentities($user['second_leader']); ?></a>
                                        <?php else: ?>
                                        <?php echo htmlentities($user['second_leader']); endif; ?>
                                </li>
                                <li>
                                    <?php if($user['third_leader'] > 0): ?>
                                        <a href="<?php echo url(detail,array('id'=>$user[third_leader])); ?>"><?php echo htmlentities($user['third_leader']); ?></a>
                                        <?php else: ?>
                                        <?php echo htmlentities($user['third_leader']); endif; ?>
                                </li>
                            </ul>
                        </span>
                        <span class="span_1">
                        ...
                        <span class="span_1">
                            <ul>
                                <li><strong class="red"><?php echo htmlentities($user['distribut_money']); ?></strong>&nbsp;元 </li>
                                <li>
                                    <?php if($user['first_leader'] > 0): ?>
                                        <a href="<?php echo url(index,array('first_leader'=>$user[user_id])); ?>"><?php echo htmlentities($user['first_lower']); ?></a>
                                        <?php else: ?>
                                        <?php echo htmlentities($user['first_leader']); endif; ?>
                                </li>
                                <li>
                                    <?php if($user['second_leader'] > 0): ?>
                                        <a href="<?php echo url(index,array('second_leader'=>$user[user_id])); ?>"><?php echo htmlentities($user['second_lower']); ?></a>
                                        <?php else: ?>
                                        <?php echo htmlentities($user['second_leader']); endif; ?>
                                </li>
                                <li>
                                    <?php if($user['third_leader'] > 0): ?>
                                        <a href="<?php echo url(index,array('third_leader'=>$user[user_id])); ?>"><?php echo htmlentities($user['third_lower']); ?></a>
                                        <?php else: ?>
                                        <?php echo htmlentities($user['third_leader']); endif; ?>
                                </li>
                            </ul>
