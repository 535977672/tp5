<?php /*a:2:{s:70:"D:\mf\pcnfctest\application\admin\view\goods\goods_attribute_list.html";i:1543196953;s:57:"D:\mf\pcnfctest\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    ...
    <div class="tDiv">
      <div class="tDiv2">
        <div class="fbutton">       
          <a href="<?php echo url('Admin/goods/addEditGoodsAttribute'); ?>">
    ...
    <div class="bDiv" style="height: auto;">
     <!--ajax 返回 --> 
      <div id="flexigrid" cellpadding="0" cellspacing="0" border="0" data-url="<?php echo url('admin/goods/delGoodsAttribute'); ?>"></div>
    </div>

     </div>
</div>
<input type="hidden" id="type" value="<?php echo htmlentities((app('request')->route('type_id') ?: '')); ?>">
<script>
...
// 表格行点击选中切换
    ...
    function ajax_get_table(form,page){
		...
		cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"/Admin/goods/ajaxGoodsAttributeList/"+page,//+tab,
                data : data,// 你的formid
                success: function(data){
                    $("#flexigrid").html('');
