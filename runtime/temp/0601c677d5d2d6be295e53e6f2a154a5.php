<?php /*a:2:{s:56:"D:\mf\pcnfc\application\admin\view\admin\admin_info.html";i:1542157672;s:53:"D:\mf\pcnfc\application\admin\view\public\layout.html";i:1542359974;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="adminHandle" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="user_name" id="user_name" maxlength="20" class="input-txt">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="email" id="email" class="input-txt" maxlength="40">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="password" name="password" maxlength="18" id="password" class="input-txt">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="role_id">
                        ...
                        <option value="<?php echo htmlentities($item['role_id']); ?>"><?php echo htmlentities($item['role_name']); ?></option>
    ...
    <form class="form-horizontal" id="adminHandle" method="post">
        <input type="hidden" name="act" id="act" value="<?php echo htmlentities($act); ?>">
        <input type="hidden" name="admin_id" value="<?php echo htmlentities($info['admin_id']); ?>">
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="user_name"><em>*</em>用户名</label>
                ...
                <dd class="opt">
                    <input type="text" name="user_name" value="<?php echo htmlentities($info['user_name']); ?>" id="user_name" maxlength="20" class="input-txt">
                    <span class="err" id="err_user_name"></span>
                    <p class="notic">用户名</p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="email" value="<?php echo htmlentities($info['email']); ?>" id="email" class="input-txt" maxlength="40">
                    <span class="err" id="err_email"></span><p class="notic">Email地址</p>
                </dd>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="password" name="password" maxlength="18" value="<?php echo htmlentities($info['password']); ?>" id="password" class="input-txt">
                    <span class="err" id="err_password"></span><p class="notic">登陆密码</p>
                </dd>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="role_id">
                        <?php if(is_array($role) || $role instanceof \think\Collection || $role instanceof \think\Paginator): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo htmlentities($item['role_id']); ?>" <?php if($item['role_id'] == $info['role_id']): ?> selected="selected"<?php endif; ?> ><?php echo htmlentities($item['role_name']); ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <span class="err" id="err_role_id"></span>
                    <p class="notic">所属角色</p>
...
<script type="text/javascript">
    ...
    function adsubmit(){
        ...
        $.ajax({
            async:false,
            url:'/Admin/Admin/adminHandle/t/'+Math.random(),
