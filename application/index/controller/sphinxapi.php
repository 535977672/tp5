...
if(!defined("SPH_RANK_PROXIMITY_BM25")) define ( "SPH_RANK_PROXIMITY_BM25",	0 );	///< alias for PROXIMITY_BM15; to be retired
if(!defined("SPH_RANK_BM25")) define ( "SPH_RANK_BM25",			1 );	///< alias for BM15; to be retired
...
if(!defined("SPH_FILTER_STRING")) define ( "SPH_FILTER_STRING",	3 );
if(!defined("SPH_FILTER_STRING_LIST")) define ( "SPH_FILTER_STRING_LIST",	6 );
...
if(!defined("SPH_ATTR_FACTORS")) define ( "SPH_ATTR_FACTORS",			1001 );
...
/// known update types
if(!defined("SPH_UPDATE_PLAIN")) define ( "SPH_UPDATE_PLAIN",		0 );
if(!defined("SPH_UPDATE_MVA")) define ( "SPH_UPDATE_MVA",			1 );
if(!defined("SPH_UPDATE_STRING")) define ( "SPH_UPDATE_STRING",		2 );
if(!defined("SPH_UPDATE_JSON")) define ( "SPH_UPDATE_JSON",			3 );
